...
async function startBootstrap() {
    ...
    if (!biosLoaded) {
        statusEl.className = 'error';
        statusEl.innerHTML = `ERROR: GBA BIOS failed to load from **${CONFIG.BIOS_FILE}**. Ensure the file is correctly committed and available.`;
        return;
    }
